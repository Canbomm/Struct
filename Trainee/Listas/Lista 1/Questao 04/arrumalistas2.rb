# Mesmo código, só que ele pega a posição da mediana baseada na lista original e não na organizada
...
if (tamanho % 2) == 0
    ...
    posicaom = [listaog.find_index(e_meio1),listaog.find_index(e_meio2)]
else
    mediana = listaordenada.delete_at((tamanho-1)/2)
    # pegando a posicao do valor no meio da lista
    posicaom = listaog.find_index(mediana)
end
